defmodule ProtoValidator.Gen.StringTest.Uuid do
  ...
  validate(:uuid,
    type: :string,
    string: [ignore_empty: true, strict: true, well_known: [uuid: true]]
  )
end
...
defmodule ProtoValidator.Gen.StringTest.Const do
  ...
  validate(:name, type: :string, string: [const: "foo", strict: true])
end
...
defmodule ProtoValidator.Gen.StringTest.Len do
  ...
  validate(:name, type: :string, string: [len: 3, strict: true])
end
...
defmodule ProtoValidator.Gen.StringTest.LenBytes do
  ...
  validate(:name, type: :string, string: [len_bytes: 4, strict: true])
end
...
defmodule ProtoValidator.Gen.StringTest.MinBytes do
  ...
  validate(:name, type: :string, string: [min_bytes: 4, strict: true])
end
...
defmodule ProtoValidator.Gen.StringTest.MaxBytes do
  ...
  validate(:name, type: :string, string: [max_bytes: 8, strict: true])
end
...
defmodule ProtoValidator.Gen.StringTest.MinMaxBytes do
  ...
  validate(:name, type: :string, string: [max_bytes: 8, min_bytes: 4, strict: true])
end
...
defmodule ProtoValidator.Gen.StringTest.MinMaxBytesEqual do
  ...
  validate(:val, type: :string, string: [max_bytes: 4, min_bytes: 4, strict: true])
end
...
defmodule ProtoValidator.Gen.StringTest.Pattern do
  ...
  validate(:val, type: :string, string: [pattern: "(?i)^[a-z0-9]+$", strict: true])
end
...
defmodule ProtoValidator.Gen.StringTest.PatternEscapes do
  ...
  validate(:val, type: :string, string: [pattern: "\\* \\\\ \\w", strict: true])
end
...
defmodule ProtoValidator.Gen.StringTest.Prefix do
  ...
  validate(:val, type: :string, string: [prefix: "foo", strict: true])
end
...
defmodule ProtoValidator.Gen.StringTest.Suffix do
  ...
  validate(:val, type: :string, string: [strict: true, suffix: "baz"])
end
...
defmodule ProtoValidator.Gen.StringTest.Contains do
  ...
  validate(:val, type: :string, string: [contains: "bar", strict: true])
end
...
defmodule ProtoValidator.Gen.StringTest.NotContains do
  ...
  validate(:val, type: :string, string: [not_contains: "bar", strict: true])
end
...
defmodule ProtoValidator.Gen.StringTest.In do
  ...
  validate(:val, type: :string, string: [in: ["bar", "baz2"], strict: true])
end